package com.gakk.noorlibrary.extralib.cardstackview;
...
import com.gakk.noorlibrary.extralib.cardstackview.internal.CardStackSetting;
import com.gakk.noorlibrary.extralib.cardstackview.internal.CardStackSmoothScroller;
import com.gakk.noorlibrary.extralib.cardstackview.internal.CardStackState;
import com.gakk.noorlibrary.extralib.cardstackview.internal.DisplayUtil;
...
public class CardStackLayoutManager
    ...
    private void updateScale(View view, int index) {
        ...
        view.setAlpha((float) (targetScale * 0.6));
        switch (setting.stackFrom) {
            case None:
