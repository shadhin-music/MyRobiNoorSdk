package com.gakk.noorlibrary.extralib.customcalender.adapters
...
import com.gakk.noorlibrary.extralib.customcalender.exceptions.InvalidCustomLayoutException
import com.gakk.noorlibrary.extralib.customcalender.utils.*
import com.gakk.noorlibrary.extralib.customcalender.utils.isEventDayWithLabelColor
import java.util.*
...
class CalendarDayAdapter(
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        dayView.findViewById<ImageView>(R.id.dayIcon)?.loadIcon(day)

        val dayLabel = dayView.findViewById<AppCompatTextView>(R.id.dayLabel) ?: throw InvalidCustomLayoutException
