...
import com.gakk.noorlibrary.extralib.customcalender.adapters.CalendarPageAdapter
import com.gakk.noorlibrary.extralib.customcalender.exceptions.ErrorsMessages
import com.gakk.noorlibrary.extralib.customcalender.exceptions.OutOfDateRangeException
...
import com.gakk.noorlibrary.extralib.customcalender.listeners.OnDayLongClickListener
import com.gakk.noorlibrary.extralib.customcalender.utils.*
import com.gakk.noorlibrary.extralib.customcalender.utils.setHeaderColor
import com.gakk.noorlibrary.extralib.customcalender.utils.setHeaderTypeface
import com.gakk.noorlibrary.extralib.customcalender.utils.setHeaderVisibility
import java.util.*
...
class CalendarView @JvmOverloads constructor(
    ...
    private fun initCalendarProperties(typedArray: TypedArray) = with(calendarProperties) {
        headerColor = typedArray.getColor(R.styleable.CalendarView_cc_headerColor, 0)
        headerLabelColor = typedArray.getColor(R.styleable.CalendarView_cc_headerLabelColor, 0)
        abbreviationsBarColor = typedArray.getColor(R.styleable.CalendarView_cc_abbreviationsBarColor, 0)
        abbreviationsLabelsColor = typedArray.getColor(R.styleable.CalendarView_cc_abbreviationsLabelsColor, 0)
        abbreviationsLabelsSize = typedArray.getDimension(R.styleable.CalendarView_cc_abbreviationsLabelsSize, 0F)
        pagesColor = typedArray.getColor(R.styleable.CalendarView_cc_pagesColor, 0)
        daysLabelsColor = typedArray.getColor(R.styleable.CalendarView_cc_daysLabelsColor, 0)
        anotherMonthsDaysLabelsColor = typedArray.getColor(R.styleable.CalendarView_cc_anotherMonthsDaysLabelsColor, 0)
        todayLabelColor = typedArray.getColor(R.styleable.CalendarView_cc_todayLabelColor, 0)
        selectionColor = typedArray.getColor(R.styleable.CalendarView_cc_selectionColor, 0)
        selectionLabelColor = typedArray.getColor(R.styleable.CalendarView_cc_selectionLabelColor, 0)
        disabledDaysLabelsColor = typedArray.getColor(R.styleable.CalendarView_cc_disabledDaysLabelsColor, 0)
        highlightedDaysLabelsColor = typedArray.getColor(R.styleable.CalendarView_cc_highlightedDaysLabelsColor, 0)
        calendarType = typedArray.getInt(R.styleable.CalendarView_cc_type, CLASSIC)
        maximumDaysRange = typedArray.getInt(R.styleable.CalendarView_cc_maximumDaysRange, 0)

        if (typedArray.hasValue(R.styleable.CalendarView_cc_firstDayOfWeek)) {
            firstDayOfWeek = typedArray.getInt(R.styleable.CalendarView_cc_firstDayOfWeek, Calendar.MONDAY)
        }

        eventsEnabled = typedArray.getBoolean(R.styleable.CalendarView_cc_eventsEnabled, calendarType == CLASSIC)
        swipeEnabled = typedArray.getBoolean(R.styleable.CalendarView_cc_swipeEnabled, true)
        selectionDisabled = typedArray.getBoolean(R.styleable.CalendarView_cc_selectionDisabled, false)
        selectionBetweenMonthsEnabled = typedArray.getBoolean(R.styleable.CalendarView_cc_selectionBetweenMonthsEnabled, false)
        previousButtonSrc = typedArray.getDrawable(R.styleable.CalendarView_cc_previousButtonSrc)
        forwardButtonSrc = typedArray.getDrawable(R.styleable.CalendarView_cc_forwardButtonSrc)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            typeface = typedArray.getFont(R.styleable.CalendarView_cc_typeface)
            todayTypeface = typedArray.getFont(R.styleable.CalendarView_cc_todayTypeface)
        }
    }
    ...
    private fun initAttributes() {
        with(calendarProperties) {
            ...
            rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).swipeEnabled = swipeEnabled
        }
    ...
    private fun initUiElements() {
        rootView.findViewById<ImageButton>(R.id.previousButton).setOnClickListener {
            rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem = rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem - 1
        }

        rootView.findViewById<ImageButton>(R.id.forwardButton).setOnClickListener {
            rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem = rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem + 1
        }
    }
    ...
    private fun initCalendar() {
        ...
        rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).adapter = calendarPageAdapter
        rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).onCalendarPageChangedListener(::renderHeader)
    ...
    private fun setUpCalendarPosition(calendar: Calendar) {
        ...
        rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem = CalendarProperties.FIRST_VISIBLE_PAGE
    }
    ...
    private fun isScrollingLimited(calendar: Calendar, position: Int): Boolean {
        fun scrollTo(position: Int): Boolean {
            rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem = position
            return true
        }
    ...
    private fun setHeaderName(calendar: Calendar, position: Int) {
        rootView.findViewById<TextView>(R.id.currentDateLabel).text = calendar.getMonthAndYearDate(context)
    ...
    fun setDate(date: Calendar) {
        ...
        rootView.findViewById<TextView>(R.id.currentDateLabel).text = date.getMonthAndYearDate(context)
    ...
    val currentPageDate: Calendar
        get() = (calendarProperties.firstPageCalendarDate.clone() as Calendar).apply {
            ...
            add(Calendar.MONTH, rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem)
        }
    ...
    fun showCurrentMonthPage() {
        val page = rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).currentItem - midnightCalendar.getMonthsToDate(currentPageDate)
        rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).setCurrentItem(page, true)
    }
    ...
    fun setSwipeEnabled(swipeEnabled: Boolean) {
        ...
        rootView.findViewById<CalendarViewPager>(R.id.calendarViewPager).swipeEnabled = calendarProperties.swipeEnabled
    }
