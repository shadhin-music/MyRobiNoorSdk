 ...
 * @DATE: 5/3/2021, Mon
 */
public abstract class VectorClock extends RelativeLayout {
     ...
     */
    public VectorClock setCalendar(Calendar calendar) {
     ...
     */
    public VectorClock setScale(float scale) {
        this.scale = scale;
     ...
     */
    public VectorClock setDiameterInDp(float diameterInDp) {
     ...
     */
    public VectorClock setDiameterInPixels(int diameterInPixels) {
     ...
     *                 Default: 1.0f
     */
    public VectorClock setOpacity(float opacity) {
     ...
     */
    public VectorClock setColor(int color) {
        this.color = color;
        main(ctx);
     ...
     */
    public VectorClock setShowSeconds(boolean showSeconds) {
    ...
    private void main(Context ctx) {
        ...
        analogSecond.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            @Override
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                VectorClock.this.setPositionFor(analogSecond);
                VectorClock.this.tickTick();
                analogSecond.removeOnLayoutChangeListener(this);
            }
        });

        analogMinute.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            @Override
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                VectorClock.this.setPositionFor(analogMinute);
                VectorClock.this.tickTick();
                analogMinute.removeOnLayoutChangeListener(this);
            }
        });

        analogHour.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            @Override
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                VectorClock.this.setPositionFor(analogHour);
                VectorClock.this.tickTick();
                analogHour.removeOnLayoutChangeListener(this);
            }
        });
        ...
        /*layoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                VectorClock.this.getViewTreeObserver().removeOnGlobalLayoutListener(layoutListener);
            }
        };
